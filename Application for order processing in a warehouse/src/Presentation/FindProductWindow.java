...
public class FindProductWindow extends JFrame {
	...
	public void findProduct(ActionListener listenForDeleteButton) {
	...
	public void setIdTextFieldToNull() {
		giveIdTextField.setText("");
	}
	
	public void setIdTextField(int value) {
		giveIdTextField.setText(Integer.toString(value));
	}
}
